export default function About() {
    return (
        <div class="md:px-20 px-5">
            <h1 class="text-6xl font-extrabold text-center pb-5">About Me</h1>
            <br />
            <div class="text-gray-400">
                <p class="mb-3 text-lg md:text-xl text-gray-400 pb-14 px-2 text-center">
                ...
                <div class="py-3">
                <h4 class="text-2xl font-bold dark:text-white py-3 px-2">My Journey</h4>
                <p class="px-2">
                ...
                <div class="py-3">
                <h4 class="text-2xl font-bold dark:text-white py-3 px-2">Why Backend Development?</h4>
                <p class="px-2">
                ...
                <div class="py-3">
                <h4 class="text-2xl font-bold dark:text-white py-3 px-2">Professional Experience</h4>
                <p class="px-2">
                ...
                <div class="py-3">
                <h4 class="text-2xl font-bold dark:text-white py-3 px-2">Continuous Learning and Growth</h4>
                <p class="px-2">
