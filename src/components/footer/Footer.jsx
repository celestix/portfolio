export default function Footer() {
    return (
        ...
        <footer class="rounded-lg shadow m-4 bg-gray-800">
            ...
            <span class="text-sm sm:text-center text-gray-400">© {new Date().getFullYear()} <a href="mailto://i@anodite.me" class="hover:underline">Anony</a> | All Rights Reserved.</span>
